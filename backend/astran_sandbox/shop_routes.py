...
Acest Shop e pentru obiecte de jocuri (props: copaci, cutii, decor etc). Hainele si
accesoriile pentru Avatar Editor au propriul lor magazin, separat - vezi clothes_routes.py.
"""
